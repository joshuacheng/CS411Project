...
export class InsertCollege extends Component {
	...
	submit = event => {
		const body = {
			...
			UniversityName: this.state.uniName,
	...
	render() {
		...
		return (
			<div>
				<p>
					Here you can insert college info in our database!
				...
				<div className={classes.supercontainer}>
					<div className={classes.container}>
						...
						{
							this.state.insertedCollege &&
							<p>Thanks for adding a college!</p>
						}
					</div>
				</div>
			</div >
...
export default withStyles(styles)(InsertCollege);